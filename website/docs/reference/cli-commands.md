...
| `hermes artifacts` | Inspect managed temporary artifacts and durable/external retention state; preview or explicitly reap expired dead-owner operations, list manifests, and promote one output. |
